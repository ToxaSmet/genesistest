...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Payment = __webpack_require__(211);

	var _Payment2 = _interopRequireDefault(_Payment);

	var _NotFound = __webpack_require__(213);
	...
	var Main = function Main() {
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(_reactRouterDom.Route, { path: '/payment/:hash', component: _Payment2.default }),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Product = __webpack_require__(208);
	...
	var List = function (_React$Component) {
	    ...
	    function List(props) {
	        ...
	        _this.state = { products: [], paginator: {}, preloader: true,
	    ...
	    _createClass(List, [{
	        ...
	        value: function getProducts() {
	            ...
	            var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '?page=1';

	            fetch('/api/v1/products/' + page, { credentials: "same-origin" }).then(function (response) {
	                ...
	                if (data.status === 'ok') {
	                    _this2.setState({ preloader: false, products: data.data, paginator: data.paginator });
	                } else if (data.status === 'err') {
	                    _this2.setState({ alert: { type: 'danger', display: 'block', text: data.msg } });
	                }
	        ...
	        key: 'changeAlertHandler',
	        value: function changeAlertHandler(type, display, text) {
	        ...
	        value: function displayAlert() {
	            return _react2.default.createElement(
	                'div',
	                { style: { display: this.state.alert.display },
	        ...
	        value: function render() {
	            ...
	            var products = this.state.products.map(function (product, id) {
	                return _react2.default.createElement(_Product2.default, { changeAlert: _this3.changeAlertHandler.bind(_this3), key: id, data: product });
	            });

	            var pagesCount = this.state.paginator.count / 10;
	            var paginator = [];
	            for (var i = 0; i < pagesCount; i++) {
	                var active = this.state.paginator.page === i + 1 ? ' active' : '';
	                paginator.push(_react2.default.createElement(
	                    'li',
	                    { key: i + 1, className: 'page-item' + active },
	                    _react2.default.createElement(
	                        _reactRouterDom.Link,
	                        { className: 'page-link', to: '/?page=' + (i + 1) },
	                        i + 1
	                    )
	                ));
	            }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Product = function (_React$Component) {
	    ...
	    _createClass(Product, [{
	        key: 'addToCartHandler',
	        value: function addToCartHandler() {
	            var _this2 = this;

	            var hash = this.props.data.hash;
	            fetch('/api/v1/cart/', {
	                ...
	                if (data.status === 'ok') {
	                    _this2.setState({ preloader: false, products: data.data });
	                    _this2.props.changeAlert('success', 'block', data.msg);
	                } else if (data.status === 'err') {
	                    _this2.props.changeAlert('danger', 'block', data.msg);
	                }
	            }).catch(function (error) {
	                console.log('Request failed', error);
	            });
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'card' },
	                _react2.default.createElement('img', { 'data-src': this.props.data.img, alt: '100%x280',
	                ...
	                _react2.default.createElement(
	                    'button',
	                    { className: 'btn btn-primary', onClick: this.addToCartHandler.bind(this) },
	                    'add to cart'
	                )
	            );
	        }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _CartProduct = __webpack_require__(210);

	var _CartProduct2 = _interopRequireDefault(_CartProduct);
	...
	var Cart = function (_React$Component) {
	    ...
	    _createClass(Cart, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            fetch('/api/v1/cart/', { credentials: "same-origin" }).then(function (response) {
	                if (response.status >= 200 && response.status < 300) {
	                    return Promise.resolve(response);
	                } else {
	                    return Promise.reject(new Error(response.statusText));
	                ...
	                if (data.status === 'ok') {
	                    ...
	                    _this2.changeAlertHandler('danger', 'block', data.err);
	                }
	            }).catch(function (error) {
	                console.log('Request failed', error);
	            });
	        ...
	        value: function changeProductCount(e, id) {
	            var _this3 = this;
	            ...
	            fetch('/api/v1/cart/', {
	                ...
	                if (data.status === 'ok') {
	                    ...
	                    _this3.setState({ products: products, sum: sum });
	                    _this3.changeAlertHandler('success', 'block', data.msg);
	                } else if (data.status === 'err') {
	                    _this3.changeAlertHandler('danger', 'block', data.msg);
	                }
	            }).catch(function (error) {
	                console.log('Request failed', error);
	            });
	        ...
	        value: function removeProduct(id) {
	            ...
	            fetch('/api/v1/cart/', {
	                ...
	                if (data.status === 'ok') {
	                    _this4.setState({ products: newProducts, sum: sum });
	                } else if (data.status === 'err') {
	                    _this4.changeAlertHandler('danger', 'block', data.err);
	                }
	            }).catch(function (error) {
	                console.log('Request failed', error);
	            });
	        ...
	        value: function confirmHandler() {
	            ...
	            fetch('/api/v1/cart/', {
	                ...
	                if (data.status === 'ok') {
	                    ...
	                    _this5.changeAlertHandler('danger', 'block', data.err);
	                }
	            }).catch(function (error) {
	                console.log('Request failed', error);
	            });
	        ...
	        value: function radioChangeHandler(e) {
	            this.setState({
	        ...
	        value: function render() {
	            ...
	            var products = this.state.products.map(function (product, id) {
	                return _react2.default.createElement(_CartProduct2.default, _extends({ key: id, changeCount: function changeCount(e) {
	                        return _this6.changeProductCount(e, id);
	                    },
	                    removeProduct: function removeProduct() {
	                        return _this6.removeProduct(id);
	                    } }, product));
	            });

	            var paymentRadio = _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(
	                    'label',
	                    { className: 'custom-control custom-radio' },
	                    _react2.default.createElement('input', { id: 'liqpay', name: 'payment', type: 'radio', value: 'liqpay', className: 'custom-control-input',
	                ...
	                _react2.default.createElement(
	                    'label',
	                    { className: 'custom-control custom-radio' },
	                    _react2.default.createElement('input', { id: 'privat', name: 'payment', type: 'radio', value: 'privat', className: 'custom-control-input',
	                ...
	                _react2.default.createElement(
	                    'label',
	                    { className: 'custom-control custom-radio' },
	                    _react2.default.createElement('input', { id: 'paypal', name: 'payment', type: 'radio', value: 'paypal', className: 'custom-control-input',
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'button',
	                                { className: 'btn btn-primary', onClick: this.confirmHandler.bind(this) },
	                                'Confirm'
	                            )
	                        )
	                    )
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var CartProduct = function (_React$Component) {
	    _inherits(CartProduct, _React$Component);

	    function CartProduct() {
	        _classCallCheck(this, CartProduct);

	        return _possibleConstructorReturn(this, (CartProduct.__proto__ || Object.getPrototypeOf(CartProduct)).apply(this, arguments));
	    }
	    ...
	    _createClass(CartProduct, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                { className: "card" },
	                _react2.default.createElement("img", { "data-src": this.props.img, alt: "100%x280",
	                    style: { height: '280px', width: '100%', display: 'block' },
	                ...
	                _react2.default.createElement("input", { className: "form-control", type: "number", min: "1", onChange: this.props.changeCount,
	                    value: this.props.count }),
	                _react2.default.createElement(
	                    "button",
	                    { className: "btn btn-primary", onClick: this.props.removeProduct },
	                    "Remove"
	                )
	            );
	        }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _PaymentProduct = __webpack_require__(212);

	var _PaymentProduct2 = _interopRequireDefault(_PaymentProduct);
	...
	var Payment = function (_React$Component) {
	    ...
	    function Payment(props) {
	        ...
	        _this.state = { products: [], payment_system: '', sum: 0, preloader: true,
	            alert: { display: 'none', type: 'success', text: '' } };
	        return _this;
	    }
	    ...
	    _createClass(Payment, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            fetch('/api/v1/payment/?hash=' + this.props.match.params.hash, {
	                ...
	                if (data.status === 'ok') {
	                    ...
	                    _this2.changeAlertHandler('danger', 'block', data.msg);
	                }
	            }).catch(function (error) {
	                console.log('Request failed', error);
	            });
	        ...
	        value: function render() {
	            ...
	            var products = this.state.products.map(function (product, id) {
	                return _react2.default.createElement(_PaymentProduct2.default, _extends({ key: id }, product));
	            });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PaymentProduct = function (_React$Component) {
	    _inherits(PaymentProduct, _React$Component);

	    function PaymentProduct() {
	        _classCallCheck(this, PaymentProduct);

	        return _possibleConstructorReturn(this, (PaymentProduct.__proto__ || Object.getPrototypeOf(PaymentProduct)).apply(this, arguments));
	    }

	    _createClass(PaymentProduct, [{
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	...
	var Header = function Header() {
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                _reactRouterDom.Link,
	                { className: 'navbar-toggler', to: '/cart' },
	                'Go to cart'
	            )
	        )
	    );
